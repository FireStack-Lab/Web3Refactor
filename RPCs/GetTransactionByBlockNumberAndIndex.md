...
| `method`  | string        | Required | `"GetTransactionByBlockNumberAndIndex"`        |
| `params`  | Array<string> | Required | `[BLOCK PARAMETER,TRANSACTION INDEX POSITION]` |
...
curl https://devnet.harmony.one \
    ...
    -d '{"jsonrpc":"2.0","method":"GetTransactionByBlockNumberAndIndex","params": ["0x5BAD55","0x0"],"id":1}'
